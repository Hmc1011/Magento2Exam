...
$sourceUrl = $this->getUrl('productslider/catalog_category_widget/chooser',
['uniq_id' => $uniqId, 'use_massaction' => false]);
$chooser = $this->getLayout()->createBlock('Packt\ProductSlider\Block\Adminhtml\Catalog\Category\Widget\Chooser')
->setElement(
$element)->setConfig(
    $this->getConfig()
    )->setFieldsetId(
